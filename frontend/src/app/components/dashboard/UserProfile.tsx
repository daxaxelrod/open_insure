      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={16}>
          <div>
            ...
            <Title level={4}>{user?.email}&nbsp;
              {
                user?.verified_email ? <CheckCircleOutlined style={{color: '#40a9ff'}} /> : 
                <Tooltip placement="right" title={"Your email is not verified. (no way to verify yet except by asking the admin)"}>
                  <InfoCircleOutlined />
                </Tooltip>
              }</Title>
              <Paragraph>
